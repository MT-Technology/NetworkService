...
Pod::Spec.new do |s|
  s.name             = 'MTWebServiceManager'
  s.version          = '0.1.2'
  s.swift_version    = '5.0'
  s.summary          = 'MTWebServiceManager is a framework that allow consume web service.'
...
I created this library to other developers, who wants implement web service in his/her proyects
  ...
  s.source_files = 'MTWebServiceManager/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MTWebServiceManager' => ['MTWebServiceManager/Assets/*.png']
  # }
